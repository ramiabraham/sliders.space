var project = 'sliders.space'
var projectURL = 'sliders.space'
var productURL = './'
...
gulp.task('styles', function () {
  gulp.src(styleSRC)
    ...
    .pipe(notify({
      message: 'sliders.space task: "styles" is totes done!',
      onLast: true
    }))
})
...
gulp.task('vendorJs', function () {
  gulp.src(jsVendorRC)
    ...
    .pipe(gulp.dest(jsVendorDestination))
    .pipe(notify({
      message: 'sliders.space task: "vendorJS" is totes done!',
      onLast: true
    }))
})
...
gulp.task('mainJS', function () {
  gulp.src(jsCustomSRC)
    ...
    .pipe(gulp.dest(jsCustomDestination))
    .pipe(notify({
      message: 'sliders.space task: "mainJS" is totes done!',
      onLast: true
    }))
})
